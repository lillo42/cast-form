...
namespace CastForm
{
    ...
    {
        IMapperBuilder<TSource, TDestiny> For<TSourceMember, TDestinyMember>(Expression<Func<TDestiny, TDestinyMember>> destiny, Expression<Func<TSource, TSourceMember>> source);
