...
{
    public class ForRuleNullableWithDifferentType : IRuleMapper, IRuleNeedLocalField
    {
        private readonly PropertyInfo _source;
        private readonly PropertyInfo _destiny;

        public ForRuleNullableWithDifferentType(MemberInfo source, MemberInfo destiny)
        {
