...
{
    public class NullableRuleForDifferentTypeFactoryTest
    {
        private readonly NullableRuleForDifferentTypeFactory _factory;

        public NullableRuleForDifferentTypeFactoryTest()
        {
            _factory = new NullableRuleForDifferentTypeFactory();
        }
        ...
        public void CreateRule()
        {
            ...
            var propertyDestiny = Substitute.For<PropertyInfo>();
            propertyDestiny.PropertyType.Returns(typeof(long?));

            var rule =  _factory.CreateRule(propertySource, propertyDestiny,
                Substitute.For<IHashCodeFactoryGenerator>());

            rule.Should().NotBeNull();
            rule.Should().BeAssignableTo<NullableRuleForDifferentType>();
