...
{
    public class ISetCollectionMappingTest
    {
        private readonly Fixture _fixture;
        private readonly IMap<string, string> _map;
        
        public ISetCollectionMappingTest()
        {
        ...
        public void ISet_From_HashSet()
        {
            ...
            var mapper = new ISetCollectionMapping<string, string>(_map);
